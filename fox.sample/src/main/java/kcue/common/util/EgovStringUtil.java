...
public class EgovStringUtil {
    ...
    public static String[] split(String source, String separator, int arraylength) throws NullPointerException {
        ...
        String[] returnVal = null;
        if(arraylength < 1) return returnVal;
	...
	try {
	    ...
	    //e.printStackTrace();
	    logger.error("**** getRandomStr exception "+e.getMessage());
	}
...
/**
	...
	try {
	   ...
	   //e.printStackTrace();
		logger.error("**** getSpclStrCnvr exception "+e.getMessage());
	...
	try {
	    ...
	    //e.printStackTrace();
	    logger.error("**** getTimeStamp exception "+e.getMessage());
	}
    ...
    public static String getHtmlStrCnvr(String srcString) {
		...
		{
			//ex.printStackTrace();
			logger.error("**** getHtmlStrCnvr exception "+ex.getMessage());
		}
