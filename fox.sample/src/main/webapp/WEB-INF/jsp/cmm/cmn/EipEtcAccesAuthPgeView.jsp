	...
	<div id="wrap">		
		...
		<div id="container2">
			<div class="mg15" id="dverr">
				...
				<div class="dv_error3 mgb60">
					<p class="error_txt1">서비스 이용에 불편을 드려서 대단히 죄송합니다.</p>
					<p class="error_txt2 mgt25">파일 접근 제한</p>
					<p class="mgt15">해당 내용을 볼 수 있는 권한이 없기 때문에 페이지를 열 수 없습니다.</p>
					<button type="button" class="mgt15" title="대학입학정보 메인페이지로 바로가기">
