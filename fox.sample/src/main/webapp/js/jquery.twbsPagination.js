...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        render: function (pages) {
            ...
            $(".first.disabled > a > img").attr("src","/images/btn_first.png");
            $(".prev.disabled > a > img").attr("src","/images/btn_prev.png");
            $(".next.disabled > a > img").attr("src","/images/btn_next.png");
            $(".last.disabled > a > img").attr("src","/images/btn_last.png");
